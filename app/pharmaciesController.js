...
import {pharmacyOnDuty} from '../app/ViewDistrictService'

export let PharmaciesController = function(pharmacyOnDuty, $http, uiGmapGoogleMapApi, $routeParams) {
  let self = this;
  ...
  self.district = $routeParams.district;
  pharmacyOnDuty.getPharmacies($routeParams.district)
                .then(onComplete, onError)
};

  app.controller("PharmaciesController", PharmaciesController )
